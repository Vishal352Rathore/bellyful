      ...
      <div className="flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 md:space-x-8">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex space-x-4">
            <img src={appStore} alt="App Store" className="w-20 md:w-24 h-auto cursor-pointer" />
            <img src={googleStore} alt="Google Play" className="w-20 md:w-24 h-auto cursor-pointer" />
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-4 ">
          ...
          <div className="bg-white rounded-3xl flex items-center w-[300px] md:w-[300px]">
            <input
              type="email"
              placeholder="Enter Email Address"
              className="p-2 h-8 rounded-full text-black border-none focus:outline-none flex-1"
            />
          ...
          <div className="flex space-x-4">
            ...
            <InstagramIcon className="cursor-pointer hover:text-gray-300" />
          </div>
        </div>
      </div>
